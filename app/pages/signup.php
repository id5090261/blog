...
<main class="form-signin w-100 m-auto">
  <form method="post">
    <a href="home">
    <img class="mb-4" src="<?=root?>/assets/images/morfle.png" alt="" width="92" height="92" style="object-fit:cover;">
    </a>
...
<?php endif;?>
    ...
    <div class="form-floating">
      <input value="<?=old_value('username')?>" name="username" type="username" class="form-control mb-2" id="floatingInput" placeholder="Username">
...
<?php endif;?>
    ...
    <div class="my-2">have an account? <a href="login">Login</a></div>
    <div class="checkbox mb-3">
      <label>
        <input <?=old_checked('terms')?> name="terms" type="checkbox" value="remember-me"> <a href="#">Accept terms and conditions</a>
      </label>
    </div>
